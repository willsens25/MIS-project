...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center">
            <a href="javascript:void(0);" onclick="window.history.back();" class="btn btn-outline-secondary btn-sm rounded-circle mr-3" title="Kembali ke Form Input" style="width: 32px; height: 32px; display: inline-flex; align-items: center; justify-content: center;">
                <i class="fas fa-arrow-left"></i>
            </a>
            <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Riwayat Invoice Pesanan</h1>
        </div>

        <a href="{{ route('marketing.index') }}" class="btn btn-primary rounded-pill shadow-sm px-3">
    ...
    <div class="card shadow border-0 rounded-lg mb-4">
        <div class="card-body">
            <form id="filter-form" action="{{ route('marketing.order.list') }}" method="GET" class="row g-3 align-items-center">
                <div class="col-md-4">
